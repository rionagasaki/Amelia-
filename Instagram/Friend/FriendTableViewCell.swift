...
class FriendTableViewCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        friendDelete.layer.borderWidth = 1
        friendDelete.layer.borderColor = UIColor.black.cgColor
        friendMap.layer.borderWidth = 1
        friendMap.layer.borderColor = UIColor.black.cgColor
